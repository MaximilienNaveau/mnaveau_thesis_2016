...
{\footnotesize
Mme Christine CHEVALLEREAU \\[-0.5ex]
M. Christian OTT \\[-0.5ex]
M. Pierre-Brice WIEBER\\[-0.5ex]
M. Florent LAMIRAUX\\[-0.5ex]
M. Olivier STASSE}
\end{minipage}
...
Rapporteur\\[-0.5ex]
Rapporteur\\[-0.5ex]
Membre du Jury\\[-0.5ex]
Membre du Jury\\[-0.5ex]
Directeur de th\`ese}
\end{minipage}
\begin{tikzpicture}[remember picture, overlay]
\node at(-10,0.8){\includegraphics[height=1cm]{logo/logo-medium-white}};
\node at(-10,-0.5){\includegraphics[height=1cm]{hrp2.jpeg}};
\node at(0.0,0.8){\includegraphics[height=1cm]{logo/koroibot-logo}};
\node at(0.0,-0.5){\includegraphics[height=1cm]{logo/LAAS-2016.jpg}};
\end{tikzpicture}
}
