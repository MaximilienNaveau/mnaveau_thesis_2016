...
\framesubtitle{
  ...
  \only<1>{
    $L_1({\bf U}_{k})$ is the linear velocity tracking 
    {\small
      \begin{equation*}
    ...
    \only<2>{$L_2({\bf U}_{k})$ is the control norm
      {\small
        \begin{equation*}
    ...
    \only<3>{$L_3({\bf U}_{k})$ is distance of the CoP to the most stable trajectory
      {\small
        \begin{equation*}
    ...
    \only<4>{$L_4({\bf U}_{k})$ is the angular velocity tracking
      {\small
        \begin{equation*}
